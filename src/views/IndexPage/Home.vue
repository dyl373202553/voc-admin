        ...
        <el-card class="box-card" v-show="slideshowList.length !==0">
            ...
            <div>
                ...
                <el-carousel-item v-for="(item, key) in slideshowList" :key="key">
                    ...
                    <img :src="item.content" class="image" style="width:100%;height: 400px;">
                    </div>
                </el-carousel-item>
                </el-carousel>
            </div>
                ...
                <el-card class="card-img">
                    ...
                    <div class="bottom clearfix">
                        ...
                        <div>
                            ...
                            <span v-show="value.superviseItemEntity.status=== '1'" class="dred">督办未发布</span>
                            <span v-show="value.superviseItemEntity.status=== '4'" class="dred">本期无督办</span>
                            <span v-show="value.superviseItemEntity.status=== '2'" class="dred">督办未回复</span>
                            <span v-show="value.superviseItemEntity.status=== '3'" class="dred">督办未确认</span>
                            <span v-show="value.superviseItemEntity.status=== '0'" class="dblue">督办已完成</span>
                        </div>
                        <div>
                            <!-- 节目状态（1：未开始，2：进行中，0：已结束） -->
                            <span class="title-left">节目状态：</span>
                            <el-button v-show="value.status=== '1'" type="primary" size="small " class="bgrey border-none dbtn" round>未开始</el-button>
                            <el-button v-show="value.status=== '2'" type="primary" size="small " class="bred border-none dbtn" round>已结束</el-button>
                            <el-button v-show="value.status=== '3'" type="primary" size="small " class="bgreen border-none dbtn" round>进行中</el-button>
                        </div>
                    </div>
                    </div>
                </el-card>
    ...
    private recentdList = [ // 近期节目
        {
            ...
            overseeState: "1",
            status: "1" // 节目状态： 1：未开始,0：已结束,2：进行中
        },
        {
            title: "客户之声第101期",
